...
```
docker run -d -p 3000:3000 -e "GF_INSTALL_PLUGINS=https://github.com/geeks-r-us/mqtt-panel/releases/download/v1.0.5/geeksrus-mqtt-panel-1.0.5.zip;mqtt-panel" --name=grafana grafana/grafana
```
